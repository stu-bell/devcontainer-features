...
# Source: https://github.com/devcontainers/features/blob/main/src/node/install.sh
# Commit: https://github.com/devcontainers/features/blob/2951f0481a488ea43a6f2ea6f18a47f0a0bf744d/src/node/install.sh
#-------------------------------------------------------------------------------------------------------------------------
#
