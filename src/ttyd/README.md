...
Installs ttyd - Share your terminal over the web. The ttyd options (port, cols, fontSize, readOnly) control the auto-generated .devcontainer/ttyd.sh script, but are ignored if a .devcontainer/ttyd.sh file already exists.
