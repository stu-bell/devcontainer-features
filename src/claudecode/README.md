...
```json
"features": {
    "ghcr.io/stu-bell/devcontainer-features/claudecode:0": {}
}
```
...
_Note: This file was auto-generated from the [devcontainer-feature.json](https://github.com/stu-bell/devcontainer-features/blob/main/src/claudecode/devcontainer-feature.json).  Add additional notes to a `NOTES.md`._
